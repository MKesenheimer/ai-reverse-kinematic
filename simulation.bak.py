...
model = keras.Sequential(
    [
        layers.Dense(64, activation="relu", name="layer1", input_shape=(2,)),
        #layers.Dropout(0.05),
...
history = model.fit(train_list_coord, train_list_alpha, epochs=50) # (49.1, 21.0, 74.2), (x, y) = (-34.6, 128.0)
...
while True:
    try:
        ...
        print("(KNN) Berchnete Winkel: " + str(angle1) + " " + str(angle2) + " " + str(angle3))
